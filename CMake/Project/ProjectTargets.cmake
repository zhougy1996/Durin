...
function(add_durin_module module_name)
	...
	if(module_reflect_headers)
		add_custom_command(
			...
			COMMAND ${DHT_MAIN} generate_module_export_file -m ${module_name} -a ${DURIN_TARGET_PLATFORM} --profile ${DURIN_PROFILE_NAME} ${DURIN_DHT_PROJECT_FILE_ARGS}
		...
		add_custom_command(
			...
			COMMAND ${DHT_MAIN} generate_reflection_files -m ${module_name} -a ${DURIN_TARGET_PLATFORM} --profile ${DURIN_PROFILE_NAME} ${DURIN_DHT_PROJECT_FILE_ARGS}
