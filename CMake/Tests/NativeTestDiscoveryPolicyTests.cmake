...
function(configure_metadata_probe probe expect_success expected_text)
	...
	if(expect_success)
		...
		if(NOT probe STREQUAL "unavailable")
			string(JSON _source_count LENGTH "${_durin_first_registry}" targets 0 sources)
			string(JSON _first_source GET "${_durin_first_registry}" targets 0 sources 0)
			string(JSON _last_source GET "${_durin_first_registry}" targets 0 sources 1)
			if(NOT _source_count EQUAL 2 OR NOT _first_source STREQUAL "Tests/A.cpp"
				OR NOT _last_source STREQUAL "Tests/Z.cpp")
				message(FATAL_ERROR "Registry source ownership must be sorted and unique.")
			endif()
		endif()
		if(probe STREQUAL "unavailable")
		...
		elseif(NOT _durin_first_registry MATCHES "\"schemaVersion\": 5")
