...
| Render Graph, RDG, pass dependencies, automatic barriers, transient lifetimes, aliasing, or async-compute scheduling | [Render Graph architecture roadmap](Roadmaps/RenderGraphArchitecture.md) |
