...
No material child plan is active. Milestone 5 has satisfied its entry gate and
is the recommended next program of work.
...
| Material Compile Lifecycle and Derived Data | M6 | Async requests, cancellation, diagnostics, last-known-good publication, cache/cook, reload, and shutdown; excludes graph UI | Create after M5 evidence satisfies its entry gate |
