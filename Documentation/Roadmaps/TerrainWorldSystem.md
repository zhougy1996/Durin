...
| [Terrain Tile Build and Cook](../Plans/Archive/2026-08/TerrainTileBuildAndCook.md) | T1 | Normalized inputs, composition, build keys/functions, tile payloads, manifests, DDC, Cook, checksums, cancellation, and source-free load; no renderer or editor surface workflow | Completed 2026-08-26; T2 entry evidence published |
