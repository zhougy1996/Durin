...
| `RenderCore` | Rendering thread, render resources, Global/Material/mesh-Material shader registration and typed maps, stable Vertex Factory descriptors, Shader compilation, portable compiled-output DDC values, local dependency manifests, scene views, simple-element value vocabulary, and renderer-module interfaces | [source](../../Engine/Source/Runtime/RenderCore) |
