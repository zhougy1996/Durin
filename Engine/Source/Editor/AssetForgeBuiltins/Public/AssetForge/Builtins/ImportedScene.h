...
namespace Durin::AssetForge::Builtins
{
	...
	struct FImportedImage
	{
		...
		FByteBuffer EmbeddedEncodedBytes;
	};
	...
	ASSETFORGEBUILTINS_API auto IsSceneSurfaceImageEncodingSupported(
		EImportedImageEncoding Encoding) -> bool;

	ASSETFORGEBUILTINS_API auto ImportFromFile(
	...
	ASSETFORGEBUILTINS_API auto ImportGeometryFromMemory(
