...
namespace Durin::Asset
{
	...
	namespace
	{
			...
			const FMeshImportOptions& Options) -> FAsyncMeshImportResult
		{
			...
			if (!Private::ReadFileBytes(RootPath, MaxImportedSourceModelBytes, RootBytes, ReadError))
			{
			...
			if (!Private::AppendDependency(
				Result.Scene,
				EImportedDependencyRole::RootModel,
				"root",
				Options.RootSource.Path,
				RootBytes))
			{
			...
			const Private::FStaticModelImportContext Context{
