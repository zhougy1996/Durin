...
from durin_project import DurinProjectConfig, DurinModuleConfig, load_project_config, load_module_config
import durin_globals as g
from durin_exports import ExportedClass, HeaderExports
...
_module_info: DurinModuleConfig = None

def init(module_info: DurinModuleConfig):
    global _module_info
