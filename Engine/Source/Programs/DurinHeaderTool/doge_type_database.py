...
from durin_exports import HeaderExports, ExportedClass, ExportedEnum, ExportedStruct, ModuleManifest, load_module_manifest
import durin_globals as g
from durin_project import *
...
def build_database(project_name: str, module_name: str) -> DurinTypeDatabase:
    db = DurinTypeDatabase() 
    project : DurinProjectConfig = get_project_config(project_name)
