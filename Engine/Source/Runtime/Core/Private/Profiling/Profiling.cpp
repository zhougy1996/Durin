...
namespace Durin::Profiling
{
	...
	auto TryLogStartupTimingSummary() -> bool
	{
		...
		DURIN_INFO(
			"StartupTiming mode={} preinit_ms={:.3f} rhi_ready_ms={:.3f} default_material_ms={:.3f} renderer_ms={:.3f} shell_ms={:.3f} workspace_registration_ms={:.3f} registry_scan_ms={:.3f} default_document_ms={:.3f} native_viewport_ready_ms={:.3f} first_present_ms={:.3f} default_workspace_ready_ms={:.3f}",
