...
namespace Durin::Asset
{
	...
	public:
		...
		ENGINE_API auto FindReferencers(const FAssetPath& Target) const
			-> std::vector<FAssetReferenceEdge>;
		ENGINE_API auto FindTargets(const FAssetPath& Source) const
	...
	ENGINE_API auto CaptureAssetReferenceIndex() -> FAssetReferenceIndex;
	ENGINE_API auto FindRedirectorsTo(const FAssetPath& Destination)
		-> std::vector<FAssetPath>;
