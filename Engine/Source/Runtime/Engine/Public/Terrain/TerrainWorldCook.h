...
namespace Durin
{
	...
	ENGINE_API auto ContributeTerrainWorldToCook(
	...
	ENGINE_API auto CookTerrainWorld(
	...
	ENGINE_API auto LoadCookedTerrainWorldManifest(
	...
	ENGINE_API auto LoadCookedTerrainProduct(
		const FAssetRuntimeConfiguration& RuntimeConfiguration,
