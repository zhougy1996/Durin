...
namespace Durin::TextureBuild
{
	...
	ENGINE_API auto ValidateEquirectangularTextureCubeProjection(uint32 Width, uint32 Height,
	...
	ENGINE_API auto ProjectEquirectangularTextureCube(const Asset::FDecodedImage& Panorama,
	...
	ENGINE_API auto ProjectEquirectangularTextureCube(const Asset::FDecodedFloatImage& Panorama,
		const FEquirectangularTextureCubeProjectionSettings& Settings,
		FTextureCubeSourceData& OutSourceData, std::string& OutError) -> bool;
}
