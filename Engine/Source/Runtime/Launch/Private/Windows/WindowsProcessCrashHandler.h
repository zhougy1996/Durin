...
namespace Durin
{
	...
	auto PublishWindowsProcessCrashRoot(std::string_view SavedDirectory, bool bExplicitDiagnosticOverride = false) -> bool;
	auto UninstallWindowsProcessCrashHandler() -> void;
	auto ConfigureWindowsProcessCrashTestOptions(
		bool bDisableDump,
