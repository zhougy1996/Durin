...
namespace Durin
{
	...
	auto ToString(ERHIGraphicsPipelineError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHIComputePipelineError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHIBufferTransitionError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHITextureTransitionError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHIBufferViewError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHITextureViewError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHITextureCopyRegionError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHICopyFootprintError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHIBufferCopyError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHIBufferTextureCopyError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHITextureCopyError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHITextureCreateError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHITextureUploadError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(ERHIVolumeUploadError Code) -> std::string_view
	{
		switch (Code)
		{
	...
	auto ToString(const FRHIShaderBindingError& Error) -> std::string
	{
	...
	auto ToString(const FRHIBufferTransitionError& Error) -> std::string
	{
		std::string Text(ToString(Error.Code));
		if (Error.Index) Text += std::format(" index={}", *Error.Index);
	...
	auto ToString(const FRHITextureTransitionError& Error) -> std::string
	{
		std::string Text(ToString(Error.Code));
		if (Error.Index) Text += std::format(" index={}", *Error.Index);
		if (Error.OtherIndex) Text += std::format(" other={}", *Error.OtherIndex);
	...
	auto ToString(const FRHIBufferCopyError& Error) -> std::string
	{
		std::string Text(ToString(Error.Code));
		if (Error.Index) Text += std::format(" index={}", *Error.Index);
		if (Error.OtherIndex) Text += std::format(" other={}", *Error.OtherIndex);
	...
	auto ToString(const FRHIBufferTextureCopyError& Error) -> std::string
	{
		std::string Text(std::visit([](auto Code) { return ToString(Code); }, Error.Code));
		if (Error.Index) Text += std::format(" index={}", *Error.Index);
		return Text;
	}

	auto ToString(const FRHITextureCopyError& Error) -> std::string
	{
		std::string Text(std::visit([](auto Code) { return ToString(Code); }, Error.Code));
		if (Error.Index) Text += std::format(" index={}", *Error.Index);
		return Text;
