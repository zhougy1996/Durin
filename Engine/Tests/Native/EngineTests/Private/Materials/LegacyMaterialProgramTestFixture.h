...
// Frozen expanded baseline for independent compiler and migration regression fixtures.
...
namespace Durin::Testing
{
	...
	inline auto MakeLegacyPBRMaterialProgram() -> FMaterialProgram
	{
	...
	inline auto MakeLegacyAggregatePBRMaterialProgram() -> FMaterialProgram
	{
		const auto Template = MakeLegacyPBRMaterialProgram();
