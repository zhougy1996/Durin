...
TEST(FStaticMeshEditorTests, ReusesOneDocumentPerMeshAndSupportsCloseReopen)
{
	...
	const Durin::FStaticMeshImportResult First = Durin::Asset::Import::ImportStaticMeshAsset(
		Source.generic_string(), "/StaticMeshEditorTests/First");
	const Durin::FStaticMeshImportResult Second = Durin::Asset::Import::ImportStaticMeshAsset(
