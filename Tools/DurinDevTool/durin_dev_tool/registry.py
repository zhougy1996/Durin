...
SCENE_HANDLER = "durin_dev_tool.scene:run"
    ...
    CommandSpec(
        ...
        subcommands=(
            CommandSpec(
                ...
                + (
                    _argument("--project", dest="project_path", type=Path, required=True),
                    _argument("--output", dest="mounted_output", required=True),
                    _argument("--width", type=float, default=20.0),
                    _argument("--depth", type=float, default=20.0),
                    _argument("--floor-thickness", dest="floor_thickness", type=float, default=0.5),
                    _argument("--wall-height", dest="wall_height", type=float, default=4.0),
                    _argument("--wall-thickness", dest="wall_thickness", type=float, default=0.5),
                    _argument("--ceiling", action="store_true"),
                    _argument("--timeout", type=int, choices=range(1, 3601), default=300, metavar="1..3600"),
                ),
            ),
        ),
    ),
